...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="/scratch/user/lihao/videos-frames", help="Path to dataset")
    parser.add_argument("--annot_path", type=str, default="/home/lihao/LSTM/data/daly1.1.0.pkl", help="Path to frames")
    parser.add_argument("--num_epochs", type=int, default=21, help="Number of training epochs")
    parser.add_argument("--batch_size", type=int, default=24, help="Size of each training batch")
    ...
    def split(all_list, shuffle=True, ratio=0.8):
        num = len(all_list)
    ...
    train_dataset.sequences, test_dataset.sequences = split(full_dataset.sequences)
